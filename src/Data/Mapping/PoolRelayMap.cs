...
namespace CGQL.NET.Server.Data.Mapping
{
    public partial class PoolRelayMap
        : IEntityTypeConfiguration<CGQL.NET.Server.Data.Entities.PoolRelay>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<CGQL.NET.Server.Data.Entities.PoolRelay> builder)
        {
