...
namespace CGQL.NET.Server.Data.Mapping
{
    public partial class DelegationMap
        : IEntityTypeConfiguration<CGQL.NET.Server.Data.Entities.Delegation>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<CGQL.NET.Server.Data.Entities.Delegation> builder)
        {
